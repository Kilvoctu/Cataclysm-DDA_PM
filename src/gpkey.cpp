...
std::string convert_to_gamepad( const std::string keybind_in )
{
    ...
    if( keybind_in == "a" ) {
        ...
        keybind_out = string_format( "L2+%s%s", gp_rstick, gp_up_right );
    } else if( keybind_in == "c" ) {
        keybind_out = string_format( "{%s}", gp_circle );
    } else if( keybind_in == "d" ) {
        keybind_out = string_format( "L2+%s%s", gp_rstick, gp_down_right );
        ...
        keybind_out = string_format( "{L2+%s%s}", gp_rstick, gp_up_left );
        ...
        keybind_out = string_format( "L2+%s%s", gp_rstick, gp_down_left );
    } else if( keybind_in == "G" ) {
        keybind_out = string_format( "{L2+%s}", gp_square );
    } else if( keybind_in == "H" ) {
        keybind_out = string_format( "L2+%s%s", gp_lstick, gp_left );
    } else if( keybind_in == "I" ) {
        keybind_out = string_format( "{L2+%s}", gp_right );
    } else if( keybind_in == "J" ) {
        keybind_out = string_format( "L2+%s%s", gp_lstick, gp_down );
    } else if( keybind_in == "K" ) {
        keybind_out = string_format( "L2+%s%s", gp_lstick, gp_up );
    } else if( keybind_in == "L" ) {
        keybind_out = string_format( "L2+%s%s", gp_lstick, gp_right );
    } else if( keybind_in == "M" ) {
        keybind_out = keybind_in;
    } else if( keybind_in == "N" ) {
        ...
        keybind_out = string_format( "L1+%s%s", gp_lstick, gp_down_left );
    } else if( keybind_in == "2" ) {
        keybind_out = string_format( "L1+%s%s", gp_lstick, gp_down );
    } else if( keybind_in == "3" ) {
        keybind_out = string_format( "L1+%s%s", gp_lstick, gp_down_right );
    } else if( keybind_in == "4" ) {
        keybind_out = string_format( "L1+%s%s", gp_lstick, gp_left );
    } else if( keybind_in == "5" ) {
        keybind_out = "L1+L3";
    } else if( keybind_in == "6" ) {
        keybind_out = string_format( "L1+%s%s", gp_lstick, gp_right );
    } else if( keybind_in == "7" ) {
        keybind_out = string_format( "L1+%s%s", gp_lstick, gp_up_left );
    } else if( keybind_in == "8" ) {
        keybind_out = string_format( "L1+%s%s", gp_lstick, gp_up );
    } else if( keybind_in == "9" ) {
        keybind_out = string_format( "L1+%s%s", gp_lstick, gp_up_right );
    } else if( keybind_in == ":" ) {
        keybind_out = "L2+L3";
    } else if( keybind_in == ";" ) {
        keybind_out = keybind_in;
        ...
        keybind_out = string_format( "L1+%s%s", gp_rstick, gp_left );
    } else if( keybind_in == "]" ) {
        keybind_out = string_format( "L1+%s%s", gp_rstick, gp_right );
    } else if( keybind_in == "{" ) {
        keybind_out = "{L1+R3}";
    } else if( keybind_in == "}" ) {
        keybind_out = "L1+R3";
        ...
        keybind_out = string_format( "L1+%s%s", gp_rstick, gp_down );
    } else if( keybind_in == "PPAGE" ) {
        keybind_out = string_format( "L1+%s%s", gp_rstick, gp_up );
        ...
        keybind_out = string_format( "L2+%s%s", gp_rstick, gp_up );
    } else if( keybind_in == "SCROLL_DOWN" ) {
        keybind_out = string_format( "L2+%s%s", gp_rstick, gp_down );
    } else if( keybind_in == "MOUSE_MOVE" ) {
        keybind_out = string_format( "%s", gp_lstick );
    } else {
        keybind_out = keybind_in;
    }
    return keybind_out;
